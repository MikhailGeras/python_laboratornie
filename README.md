...
| ЛР7 | Логирование и обработка ошибок в Python | [перейти](LR7/) |
| ЛР8 | Клиент-серверное приложение на Python с использованием Jinja2 | [перейти](LR8/) |
| ЛР9 | CRUD для приложения отслеживания курсов валют c SQLite базой данных | [перейти](LR9/) |